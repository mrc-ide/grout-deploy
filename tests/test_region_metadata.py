...
def get_mock_cfg():
    ...
    mock_datasets_cfg.get_dataset_region_metadata_levels.return_value = [
        "l1",
        "l2",
    ]
...
def test_download_no_refresh(
    mock_packit_get_artefacts,
    mock_packit_download,
    mock_remove,
    mock_makedirs,
    mock_path_exists,
):
    ...
    mock_makedirs.assert_has_calls(
        [call("testPath/d1/l2"), call("testPath/d2/l1"), call("testPath/d2/l2")]
    )
