...
def test_download_no_refresh(mock_packit_download, mock_remove, mock_makedirs, mock_path_exists):
...
@patch("os.remove")
@patch("src.grout_deploy.datasets.GroutPackit.download_file")
def test_download_refresh_all(mock_packit_download, mock_remove, mock_makedirs, mock_path_exists):
    mock_cfg = get_mock_cfg()
    path = "testPath"
